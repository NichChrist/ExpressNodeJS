...
export default interface IModifierService {
    createModifier: (productBody: IModifier, req: Request) => Promise<ApiServiceResponse>
    ...
    updateModifierById: (id: string, modifierBody: IModifier) => Promise<ApiServiceResponse>
